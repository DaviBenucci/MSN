...
Use estes blocos na ordem abaixo em containers separados do Elementor. O CSS pode ser colado por secao ou reunido no CSS da pagina.

1. `01-hero.html` + `01-hero.css`
2. `02-benefits.html` + `02-benefits.css`
